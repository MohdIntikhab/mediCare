...
import { Key,X, Menu, User } from 'lucide-react';
...
export const Navbar = () => { 
  ...
  useEffect(() => {
    const handleScroll = () => {
      const currentScrollY = window.scrollY; //window.scrollY is a built-in browser property (JavaScript DOM API)
