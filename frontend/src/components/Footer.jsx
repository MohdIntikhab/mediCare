      ...
      <div className={footerStyles.mainContent}>
          ...
          <div className={footerStyles.companySection}>
            ...
            <div className={footerStyles.contactContainer}>
              <div className={footerStyles.contactItem}>
                ...
                <span className={footerStyles.contactText}> +91 7088156432</span>
              </div>
              ...
              <div className={footerStyles.contactItem}>
                ...
                <span className={footerStyles.contactText}>medicareservices@gmail.com</span>
              </div>
              ...
              <div className={footerStyles.contactItem}>
                ...
                <span className={footerStyles.contactText}>Bareilly, India </span>
              </div>
            </div>
          </div>
          {/* quick link */}
        ...
        <div className={footerStyles.bottomSection}>
          ...
          <div className={footerStyles.designerText}>
            ...
            <a href="https://hexagondigitalservices.com" target="_blank" className={footerStyles.designerLink}>
