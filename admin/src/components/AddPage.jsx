...
import { Calendar, CheckCircle, EyeClosed, Plus, Trash2, User, XCircle } from 'lucide-react';
...
const AddPage = () => { 
  ...
  function addSlotToForm() {
    ...
    // if the date is of today then prevent from time 
    if (slotDate === today) {
      const now = new Date();
  ...
  // this will convert schedule object into an array 
  ...
  async function handleAdd(e) {
    ...
    try {
      ...
      const API_BASE = "https://medicare-backend-0p9q.onrender.com/api";
      ...
      //Reset the field after the submit done
      setForm({
        name: "",
        specialization: "",
        imageFile: null,
