...
export default function ListServicePage() {
  ...
  // sort the slot as the latest comes first by date 
...
// to fetch services from the server side 
  ...
  // to validate slots is not previous days or time 
  ...
  // Format the slot for backend ex- DD-MM-YEAR with HH:MM AM/PM
  ...
  // Convert slot object to timestamp in local timezone 
  ...
  //to edit any service we save then a particular service 
